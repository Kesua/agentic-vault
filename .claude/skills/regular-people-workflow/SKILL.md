...
This is a Claude Code mirror of `regular_people_workflow` from `.agents/skills/`.
Original source: `.agents/skills/regular_people_workflow/SKILL.md`
Skill class: `regular`
