...
This is a Claude Code mirror of `adhoc_spreadsheet_skills` from `.agents/skills/`.
Original source: `.agents/skills/adhoc_spreadsheet_skills/SKILL.md`
Skill class: `adhoc`

## Default invocation
- Use $adhoc_spreadsheet_skills to create or update a spreadsheet with the right formulas, structure, and formatting. If editing an existing source file, copy it into `70_Exports/YYYY/MM/DD/`, modify only the exported copy, and return the exported path plus a concise summary.
