...
## Default invocation
- Use $adhoc_pdf_skills to create, edit, or review a PDF. If editing an existing source file, copy it into `70_Exports/YYYY/MM/DD/`, modify only the exported copy, and return the exported path plus a concise summary.
