---
name: "regular-meeting-attendees-people-sync"
description: "Wrapper skill: create or refresh people notes from meetings and stored replied-thread participants."
---

# Regular People Sync

This is a Claude Code mirror of `regular_meeting_attendees_people_sync` from `.agents/skills/`.
Original source: `.agents/skills/regular_meeting_attendees_people_sync/SKILL.md`
Skill class: `regular`
