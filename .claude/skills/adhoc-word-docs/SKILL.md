...
This is a Claude Code mirror of `adhoc_word_docs` from `.agents/skills/`.
Original source: `.agents/skills/adhoc_word_docs/SKILL.md`
Skill class: `adhoc`

## Default invocation
- Use $adhoc_word_docs to create, edit, or review a .docx file. If editing an existing source file, copy it into `70_Exports/YYYY/MM/DD/`, modify only the exported copy, and return the exported path plus a concise change summary.
